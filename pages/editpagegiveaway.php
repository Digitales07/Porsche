...
if(isset($_POST['givea'])&&!isset($_POST['submit'])&&!isset($_POST['edit']))
	{
	 $lid=0;    
	    $n = $_POST['namee'];
	    $r= $_POST['rec'];
...
else if(isset($_POST['submit'])&&!isset($_POST['edit']))
	{
	...
	if(mysqli_query($conn,$sql) )
     ...
     $value='Not enough items in stock';
 }
...
?>
                        ...
                        <div class="col-lg-4">
                        <form enctype="multipart/form-data"  action="editpagegiveaway.php" method="post">
...
Quantity:  <input type="text" value="<?php echo $val; ?>" name="qt" style="float:right;" required="required">
